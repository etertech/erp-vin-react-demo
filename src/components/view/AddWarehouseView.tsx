...
interface AddWarehouseViewProps {
...
const AddWarehouseView: React.FC<AddWarehouseViewProps> = (props) => {
...
const [newAddress, setNewAddress] = useState<Address>({ street: "",
postalCode: "",
city: "",
state: "",
country: "",});
  ...
  return (
    <Row className="d-flex justify-content-center p-3 pt-5">
      <Card className="max-width-50-rem p-0">
        <Card.Header className="text-center">Ajouter une entrepôt</Card.Header>
        <Form className="p-4">
          ...
          <Row className="pb-3 ps-3 pe-3">
            <Col className="p-1">
              <Nav.Link
                ...
                as={Link} to="/infoPage/Warehouse"
                onClick={() => props.addWarehouse(fields)}
              >
                Ajouter
              </Nav.Link>
            </Col>
