...
const AddSupplierView: React.FC<AddSupplierViewProps> = (props) => {
  ...
  return (
    <Row className="d-flex justify-content-center p-3 pt-5">
      <Card className="max-width-50-rem p-0">
        <Card.Header className="text-center">Ajouter un fournisseur</Card.Header>
          ...
          <Row className="pb-3 ps-3 pe-3">
            <Col className="p-1">
              <Nav.Link
                ...
                as={Link}
                to="/infoPage/Supplier"
                onClick={() => 
                  {
                    const newFields = {...fields, addedDate: moment().format()}
                    props.addSupplier(newFields)}
                  }
