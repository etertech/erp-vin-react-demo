...
interface ConnectionViewProps {
    fetchUser: (login: string, password: string) => void;
}

export default function ConnectionView(props: ConnectionViewProps) {
                ...
                <Row className="ps-3 pe-3">
                    ...
                    <Col sm={{ offset: 1, span: 10 }} md={{ offset: 0, span: 7 }} lg={7}>
                        <InputGroup className="mb-3">
                            ...
                            <Form.Control 
                                type="password" // Change this to "password" to hide the input
